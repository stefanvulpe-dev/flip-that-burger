...
export function PresentationSection({
  ...
  return (
    <section className='w-11/12 max-w-6xl mx-auto pt-10 grid md:grid-cols-2 gap-6 md:gap-4 justify-items-center md:justify-items-start'>
      <p className='uppercase w-full text-center md:text-start text-accent-200 font-semibold md:self-end'>
        {subtitle}
      </p>
      ...
      <Link
        to={link}
        className='w-5/6 max-w-[15rem] text-accent-400 text-center text-sm lg:text-base font-semibold bg-accent-200 rounded-full px-8 py-4 transition-colors hover:bg-accent-300 md:row-start-4 md:row-end-5 md:self-start'>
